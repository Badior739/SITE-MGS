    ...
    <div className="bg-[#02040a] min-h-screen text-white">
      ...
      <section className="py-32 bg-[#02040a] relative overflow-hidden">
         ...
         <div className="container mx-auto px-6 text-center relative z-10">
            ...
            <Link href="/careers" className="inline-flex items-center gap-3 px-10 py-5 bg-white text-black font-bold text-lg rounded-full hover:bg-emerald-400 hover:text-white transition-all transform hover:-translate-y-1 shadow-[0_0_30px_rgba(255,255,255,0.2)]">
