                   ...
                   <div className="flex items-center gap-4 border-t border-[var(--border-subtle)] pt-4">
                       <div className="relative w-12 h-12 shrink-0">
                          <Image 
                            ...
                            fill
                            className="rounded-full object-cover ring-2 ring-[var(--bg-primary)]" 
                          />
                       </div>
                      <div>
         ...
         <div className="container mx-auto px-6">
            <div className="grid lg:grid-cols-2 gap-16 items-center mb-16">
               ...
               >
                  ...
                  <Link href="/portfolio" className="inline-flex items-center gap-2 text-[var(--text-main)] font-bold hover:text-[var(--primary-color)] transition-colors border-b-2 border-current pb-1">
